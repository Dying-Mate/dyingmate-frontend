const ColumnData = [
  {
    ...
    "content": "각종 통계자료나 보도 자료를 통해 우리사회의 고령화 속도에 대한 많은 우려의 목소리가 있다. 통계청이 발표한 ‘세계와 한국의 인구현황 및 전망’에 따르면 한국의 고령인구 구성비는 2060년 40.1%까지 증가하게 되고 이에 따라 질병의 증가, 치료비 등 경제적 빈곤,",
  ...
  },
  {
    ...
    "link": "https://www.betterfuture.go.kr/front/notificationSpace/columnDetail.do?articleId=152"
  },
  {
  ...
  {
    "title": "웰빙을 넘어 웰다잉을 이야기하다",
    "content": "갑작스럽게 사망하는 일부 경우를 제외한다면, 현대인의 대다수는 생의 마지막 순간에 암을 비롯한 만성질환을 앓다가 죽음을 맞이하게 된다. 의학의 발달로 평균 수명이 아무리 연장되어도, 누구나 언젠가는 회복 불가능한 건강 상태에 이를 수밖에 없다. 암과 같은 질환의 경우에",
    "link": "https://www.amc.seoul.kr/asan/depts/psy/K/bbsDetail.do?menuId=862&"
  },
  {
    "title": "일상에서 죽음을 말하자!",
